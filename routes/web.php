...
use App\Http\Controllers\LavemsController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::redirect('/', 'Pages/Authentication/Login');
...
Route::prefix('Interface')->group(function () {
    ...
    Route::prefix('Content')->group(function () {
        ...
        Route::prefix('Icons')->group(function () {
            ...
            Route::view('CSLineIcons', 'interface/content/icons/cs_line_icons');
            Route::view('CSLineInterfaceIcons', 'interface/content/icons/cs_line_interface_icons');
